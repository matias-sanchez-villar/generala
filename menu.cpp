...
void jugar1(char *nombre,int *punto)
{
    ...
    for(x=0; x<turnos; x++)
    {
        ...
        cout<<"\t Ronda "<<x+1<<" "<<endl;
        cout<<"\t sus puntos hasta ahora son de "<<puntos<<endl<<endl;
        tirarDados(dados, t1);
        mostrarDados(dados, t1);
        locate(22, 9);
        cambiarDados(dados, t1, nombre1, x);
        puntos+=sumarPuntos(dados, t1, jugadas, t2);
        locate(22, 9);
        cout<<endl<<endl<<"\t Sus puntos son "<<puntos<<endl<<endl;
        if (x==0 && puntos==50)
        {
...
void jugar2(char nombre [],int *punto)
{
    ...
    for(x=0; x<10; x++)
    {
        cout<<endl<<"\t jugador "<<nombre1<<endl;
        cout<<"\t ronda "<<x+1<<" "<<endl;
        cout<<"\t sus puntos hasta ahora son de "<<puntos1<<endl<<endl;
        tirarDados(dados, t1);
        mostrarDados(dados, t1);
        locate(22, 9);
        cambiarDados(dados, t1,nombre1, x);
        ...
        locate(22, 9);
        cout<<endl<<endl<<"\t sus puntos son "<<puntos1<<endl<<endl;
        if (x==0 && puntos1==50)
        {
        ...
        cout<<"\t Ronda "<<x+1<<" "<<endl;
        cout<<"\t sus puntos hasta ahora son de "<<puntos2<<endl<<endl;
        tirarDados(dados, t1);
        mostrarDados(dados, t1);
        locate(22, 9);
        cambiarDados(dados, t1, nombre2,x);
        puntos2+=sumarPuntos(dados, t1, jugador2, t2);
        locate(22, 9);
        cout<<endl<<endl<<"\t Sus puntos son "<<puntos2<<endl<<endl;
        if (x==0 && puntos2==50)
        {
